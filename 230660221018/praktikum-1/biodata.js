...
const namaLengkap = "Intan Kartika"; // Ganti dengan nama lengkapmu
const tempatLahir = "Sumedang";
let tanggalLahir = "27 September 2005"; // Format bisa disesuaikan
...
const namaGanti = namaLengkap.replace("Kartika", "K.");
