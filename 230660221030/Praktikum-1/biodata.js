...
const namaLengkap = "Syifa Nur Insani"; // Ganti dengan nama lengkapmu
const tempatLahir = "Sumedang";
let tanggalLahir = "28 Januari 2005"; // Format bisa disesuaikan
...
const namaGanti = namaLengkap.replace("Insani", "I.");
